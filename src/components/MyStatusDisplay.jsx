  ...
  const nutrients = [
    {
      ...
      goal: totalProtein,
      color: "#3B82F6",
      icon: GiChickenOven, // nicer protein icon
    },
    {
      label: "Fats",
      ...
      goal: totalFats,
      color: "#FACC15",
      icon: GiCookingPot, // representing oils/fats nicely
    },
    {
      label: "Carbs",
      ...
      goal: totalCarbs,
      color: "#22C55E",
      icon: GiWheat, // representing carbs like wheat/grains
    },
  ];
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="flex items-center  gap-2 text-left">
        ...
        <span className="font-semibold text-emerald-700">{profile.goal}</span>
      </div>
