    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start sm:items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white rounded-2xl w-[350px] h-[70vh] overflow-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden relative">
        ...
        <div className="relative w-full h-48 sm:h-64 rounded-lg overflow-hidden mb-4">
          ...
          <div className="absolute bottom-0 left-0 w-full bg-black bg-opacity-80 text-white text-lg sm:text-xl font-bold p-2 text-center">
            {dish.name}
        ...
        {/* Serving size */}
        <div className="mb-4 flex flex-col text-center sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        {/* Nutritional Cards */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-4 bg-black p-2 sm:p-3 rounded-lg">
          {[
            ...
            >
              <div className="text-xs sm:text-xs text-black">{n.label}</div>
              <div className="text-sm sm:text-sm font-semibold text-lime-500">
