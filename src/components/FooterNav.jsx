...
export default function FooterNav() {
  ...
  return (
    <div className="w-full bg-black/90 backdrop-blur-md border-t border-gray-200 rounded-t-2xl shadow-[0_-4px_20px_rgba(0,0,0,0.05)] h-[80px] flex items-center justify-around z-50">
      {/* Home */}
      <NavButton
        label="Home"
        icon={<FiHome size={22} />}
      ...
      <div className="absolute -top-6 left-1/2 -translate-x-1/2">
        <label
          ...
          className="bg-black text-lime-400 rounded-full shadow-lg w-16 h-16 flex items-center justify-center cursor-pointer transition-all duration-300 active:scale-95 border-4 border-white"
        >
          <FiPlus size={32} />
          <input
            id="cameraUpload"
